...
import alarm from '../assets/sounds/alarm-clock.mp3'
...
export default function Timer({isOverlay}) {
  ...
  return (
    ...
    <div>
        ...
        <button className='bg-blue-500 text-stone-200 px-20 py-1 rounded-xl
        text-xl mt-1 ml-1'
    ...
    setSeconds(0)}
            ...
            <>
            <button className='start text-5xl text-green-500 m-2'
            onClick={()=> setIsActive(true)}>&#9658;</button>
            <button className='start text-4xl text-yellow-500 m-2'
